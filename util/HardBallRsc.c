...
char *AppResourceList[] = {
	":Rsc:"RESOURCE_FILE_PREFIX"HardBallBoard", 
	":Rsc:"RESOURCE_FILE_PREFIX"HardBallHighScores", 
	":Rsc:"RESOURCE_FILE_PREFIX"HardBallMisc", 
	":Rsc:"RESOURCE_FILE_PREFIX"HardBallNewHighScore", 
